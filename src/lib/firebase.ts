...
import { getFirestore, collection, doc, setDoc, deleteDoc, getDoc, onSnapshot, getDocFromServer } from "firebase/firestore";
...
/**
 * Handle Firestore operation errors with compliant diagnostic structures
 */
